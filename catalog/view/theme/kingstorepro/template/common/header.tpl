...
<head>
	...
	// Carousel brands
	if($config->get( 'carousel_module' ) != '') $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/carousel.css';
	
	// Nivo slider
	if($config->get( 'slideshow_module' ) != '') $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/css/slideshow.css';
	...
	<?php echo $theme_options->compressorCodeCss( $config->get('theme_' . $config->get('config_theme') . '_directory'), $listcssjs, $theme_options->get( 'compressor_code_status' ), HTTP_SERVER ); ?>
	...
	<link rel="stylesheet" href="catalog/view/theme/<?php echo $config->get; ?>/skins/store_<?php echo $theme_options->get( 'store' ); ?>/<?php echo $theme_options->get( 'skin' ); ?>/css/custom_code.css">
	<?php } ?>
	...
	<?php } ?>
    	...
    	<?php $listcssjs = array(); 
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.min.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery-migrate-1.2.1.min.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.easing.1.3.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/bootstrap.min.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/twitter-bootstrap-hover-dropdown.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/common.js';
    $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.cookie.js';
		$listcssjs[] =	'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.themepunch.plugins.min.js';
    		$listcssjs[] =	'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.themepunch.revolution.min.js';
	    		$listcssjs[] =	'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.magnific-popup.min.js';
    		$listcssjs[] =	'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.elevateZoom-3.0.3.min.js';
			$listcssjs[] =	'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/owl.carousel.min.js';
			
    
    // Nivo slider
    if($config->get( 'slideshow_module' ) != '') $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.nivo.slider.pack.js';
    
    // Carousel brands
    if($config->get( 'carousel_module' ) != '') $listcssjs[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/jquery.jcarousel.min.js';
 
    ?>
        	
    <?php echo $theme_options->compressorCodeJs( $config->get('theme_' . $config->get('config_theme') . '_directory'), $listcssjs, $theme_options->get( 'compressor_code_status' ), HTTP_SERVER ); ?>
	...
	<script type="text/javascript" src="catalog/view/theme/<?php echo $config->get; ?>/skins/store_<?php echo $theme_options->get( 'store' ); ?>/<?php echo $theme_options->get( 'skin' ); ?>/js/custom_code.js"></script>
	<?php } ?>
	...
	<!--[if lt IE 9]>
		...
		<script src="catalog/view/theme/<?php echo $config->get; ?>/js/respond.min.js"></script>
	<![endif]-->
</head>	
<body>
