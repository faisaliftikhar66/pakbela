...
class ControllerExtensionModuleTGKSProRevolutionSlider extends Controller {
	...
	public function slider() {
		...
		if(isset($_GET['slider_id'])) {
			...
			if($data == false) { 
				$this->response->redirect($this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'user_token=' . $this->session->data['user_token'], true));
			}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider/slider', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/tg_kspro_revolution_slider', 'user_token=' . $this->session->data['user_token'], true)
		);
	...
	public function sliders() {
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'user_token=' . $this->session->data['user_token'], true);
		$data['placement'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'user_token=' . $this->session->data['user_token'], true);		
		$data['existing'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'user_token=' . $this->session->data['user_token'], true);	
		$data['link_slider'] = $this->url->link('extension/module/tg_kspro_revolution_slider/slider', 'user_token=' . $this->session->data['user_token'], true);	
		$data['user_token'] = $this->session->data['user_token'];
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_kspro_revolution_slider', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'user_token=' . $this->session->data['user_token'], true);
		$data['placement'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'user_token=' . $this->session->data['user_token'], true);		
		$data['existing'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'user_token=' . $this->session->data['user_token'], true);		
		$data['user_token'] = $this->session->data['user_token'];
