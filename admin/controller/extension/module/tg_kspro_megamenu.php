...
class ControllerExtensionModuleTGKSProMegamenu extends Controller {
	...
	public function index() {  
		...
		if(isset($_GET['delete'])) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_kspro_megamenu', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_megamenu', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/tg_kspro_megamenu', 'user_token=' . $this->session->data['user_token'], true)
		);
