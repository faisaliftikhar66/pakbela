...
class ControllerExtensionModuleTGKSproFilterProduct extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_kspro_filter_product', 'user_token=' . $this->session->data['user_token'], true));			
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_filter_product', 'user_token=' . $this->session->data['user_token'], true);
